                ...
                <table class="table card-table table-vcenter text-nowrap datatable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $row->name }}</td>
                      <td>{{ $row->jabatan }}</td>
                      <td><a href="#" data-bs-toggle="modal" class="buttonedit" data-nik={{$row->nik}} data-nama_lengkap={{$row->nama_lengkap}} data-name={{$row->name}}  data-jabatan={{$row->jabatan}} data-lead_id={{$row->lead_id}} data-id={{$row->id}} data-bs-target="#modal-edit">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Update Edit</h5>
