...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="index.html">Manajemen Sederhana</a>
			</div>
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="/logout" class="btn btn-sm btn-secondary">Logout >></a></li>
							</ul>
						</li>
						<!-- <li>
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="/admin/leader" class="active"><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
						<li>
	...
	<script src="{{ asset('assets/vendor/jquery.easy-pie-chart/jquery.easypiechart.min.j')}}s"></script>
